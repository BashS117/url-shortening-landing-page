...
const Footer = () => {
  return (
             ...
             <footer className='pt-[70px] relative top-[-1px] h-[20rem] bg-[var(--Very-Dark-Violet)] flex w-full justify-between px-[166px] text-base font-bold items-start '>
            ...
            <div className='flex'>
                ...
                <div className='grid grid-cols-3 w-[535px] font-medium text-[var(--Gray)] text-start' >
                    ...
                    <ul className='flex flex-col justify-between h-[140px]'><h2 className='mb-4'>Resources</h2>
                        <li> <p>Blog</p></li>
                        <li> <p>Developers</p></li>
                        <li><p>Support</p></li>
                    </ul>
                    <ul className='flex flex-col justify-between h-[180px]'><h2 className='mb-4'>Company</h2>
                        <li><p>About</p> </li>
                        <li><p>Our Team</p></li>
                        <li><p>Careers</p></li>
                        <li><p>Contact</p></li>
