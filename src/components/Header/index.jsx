...
console.log(menuOpen)
    return (
        <nav className='menu-mobile bg-[var(--Off-white)] flex w-full  items-center fixed z-20 top-0 py-10  px-[166px]  text-base font-bold sm:px-[30px] sm:py-8 sm:pb-5 sm:justify-between '>
<div>
